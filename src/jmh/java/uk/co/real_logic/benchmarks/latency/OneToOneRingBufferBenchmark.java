...
import uk.co.real_logic.agrona.concurrent.ringbuffer.*;
...
public class OneToOneRingBufferBenchmark
{
    ...
    public static class SharedState
    {
        ...
        public synchronized void setup()
        {
            ...
            ringBuffer = new OneToOneRingBuffer(new UnsafeBuffer(ByteBuffer.allocateDirect(BUFFER_LENGTH)));
